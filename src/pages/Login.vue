      ...
      <div v-show="!err2005" class="">
        <div v-if="login==1" class="loginBox">
          ...
          <div class="otherLogin">
            <!--            <a href="http://127.0.0.1:8843/oauth/render/gitee">-->
            <a :href="giteeUrl" @click="getThirdPartyLogin('gitee')"> <img src="https://cdn.jsdelivr.net/gh/justauth/justauth-oauth-logo@1.11/gitee.png"
                              style="width: 36px;padding-right: 30px;"></a>


            <img src="https://cdn.jsdelivr.net/gh/justauth/justauth-oauth-logo@1.11/gitee.png"
                 style="width: 36px;padding-right: 30px;">

            <img src="https://raw.githubusercontent.com/justauth/justauth-oauth-logo/v1.11/dingtalk.png"
                 style="width: 36px;">
          ...
          <!--          <div class="section" v-for="(item,index) in loginList" :key="index">-->
          <!--            <img :src="'https://cdn.jsdelivr.net/gh/justauth/justauth-oauth-logo@1.11/' + ${authPlatform.enname} + '.png'"-->
          <!--                 alt="" style="width: 20px;position: relative;top: -2px;;" class="mr-1">-->
          <!--            loginList-->
...
<script>
import {thirdPartyLogin, userLogin, userRegister} from '../api/user.js'
...
export default {
  ...
  methods: {
    getThirdPartyLogin(source) { // 获取第三方登录信息
      thirdPartyLogin(source).then((response) => {
        // console.log(response)
        this.giteeUrl = response
